...
<html>
    <head>
        ...
        googletag.cmd.push(() => {
            ...
            googletag
            .defineSlot("/India", [728, 90], "banner-ad1")
            .addService(googletag.pubads());

            googletag
            .defineSlot("/India", [728, 90], "banner-ad2")
            .addService(googletag.pubads());

            googletag
            .defineSlot("/India", [728, 90], "banner-ad3")
            .addService(googletag.pubads());

            googletag
            .defineSlot("/India", [728, 90], "banner-ad4")
            .addService(googletag.pubads());

            googletag
            .defineSlot("/India", [300, 250], "card-ad1")
            .addService(googletag.pubads());

            googletag
            .defineSlot("/India", [300, 250], "verticle-ad1")
            .addService(googletag.pubads());
     ...
     <!-- Google tag (gtag.js) --> <script async src="https://www.googletagmanager.com/gtag/js?id=AW-931280000"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-931280000'); </script>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5J6S8TFP"
        ...
        <!-- End Google Tag Manager (noscript) -->
            @include('template.users.include.header')
            @include('template.users.include.popup')
 
       
            @yield('content')

            @include('template.users.include.footer')
