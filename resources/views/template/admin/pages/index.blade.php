    ...
    <div class="row">
        <div class="page_title d-flex align-items-center">
            ...
            <div class="page_title_btn ms-auto">
                <a href="{{route('pages.create')}}" class="btn btn_theme" id="createPage">Add Page</a>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
var page ='';
var myurl = '{{route('pages.tableData')}}';

page= $('#page_tabl').DataTable({
    processing: true,
    serverSide: true,
    ajax: {
        url:   '{{route('pages.tableData')}}?source=page',
        type: 'GET',
    },
    columns: [
        { data: 'id', name: 'id' },
        ...
        
        {
            ...
            render: function (data, type, row) {
                ...
                editurl = `{{ route('pages.index') }}/`+row.id+`/edit`;
                viewurl = `{{ url('/') }}/`+row.slug;
