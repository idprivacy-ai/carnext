                            ...
                            <div class="collapse" id="filterYear">
                                <div class="select_filter">
                                    ...
                                    <option selected disabled>Select Year</option>
                                        @foreach($finalvalue['facets']['year'] as $key =>$value)
                                       
                                        <option value="{{ $value['item']}}" @if(isset($input['year']) && ($input['year'] == $value['item'])) selected @endif>{{ $value['item']}}</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-lg-10 col-12 order-lg-1">
                            ...
                            <div class="tags-container">
                                <form id="filter-form" action="{{ route('vechile') }}" method="GET">
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <div class="row g-xl-3 g-2">
                                                        ...
                                                        if ($value == '0-10000') {
                                                            ...
                                                            $rangevaue = "Above $" . number_format(70000);
                                                        } else {
                                                            $myval = explode('-', $value);
